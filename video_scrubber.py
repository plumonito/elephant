...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        icon = QIcon.fromTheme(
            QIcon.ThemeIcon.MediaPlaybackStart, style.standardIcon(QStyle.SP_MediaPlay)
        )
        ...
        icon = QIcon.fromTheme(
            QIcon.ThemeIcon.MediaPlaybackPause, style.standardIcon(QStyle.SP_MediaPause)
        )
        ...
        icon = QIcon.fromTheme(
            QIcon.ThemeIcon.MediaPlaybackStop, style.standardIcon(QStyle.SP_MediaStop)
        )
        ...
        about_qt_act = QAction(
            icon, "About &Qt", self, triggered=qApp.aboutQt
        )  # noqa: F821
